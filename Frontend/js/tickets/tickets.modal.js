...
const MODAL_CONFIG = [
    {
        ...
        ruta:
            `${COMPONENTS_BASE_URL}/modal-add-ticket.html`
    },
    {
        contenedorId:
        ...
        ruta:
            `${COMPONENTS_BASE_URL}/modal-view-ticket.html`
    },
    {
        contenedorId:
        ...
        ruta:
            `${COMPONENTS_BASE_URL}/modal-edit-ticket.html`
    },
    {
        contenedorId:
        ...
        ruta:
            `${COMPONENTS_BASE_URL}/modal-comments-ticket.html`
    }
];
